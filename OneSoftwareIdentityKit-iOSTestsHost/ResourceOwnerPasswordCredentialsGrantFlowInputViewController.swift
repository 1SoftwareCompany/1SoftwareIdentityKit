...
//  OneSoftwareIdentityKit-iOSTestsHost
//
...
import Foundation
import UIKit
import OneSoftwareIdentityKit

class ResourceOwnerPasswordCredentialsGrantFlowInputViewController: UITableViewController, UITextFieldDelegate {
    ...
    @IBAction func loginAction() {
        ...
        guard let username = self.usernameTextField.text?.trimmingCharacters(in: .whitespacesAndNewlines), username.isEmpty == false else {
        ...
        guard let password = self.passwordTextField.text?.trimmingCharacters(in: .whitespacesAndNewlines), password.isEmpty == false else {
