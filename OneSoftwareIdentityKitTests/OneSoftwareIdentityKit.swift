//
//  OneSoftwareIdentityKitTests.swift
//  OneSoftwareIdentityKitTests
//
...
class TestNetworkClient: NetworkClient, @unchecked Sendable {
    ...
    func perform(_ request: URLRequest) async throws -> OneSoftwareIdentityKit.NetworkResponse {
...
class OneSoftwareIdentityKitTests: XCTestCase {
