        ...
        switch self.method {
            ...
            case .body:
                ...
                guard request.value(forHTTPHeaderField: "Content-Type") == "application/x-www-form-urlencoded" else {
                    ...
                    error = OneSoftwareIdentityKitError.authorizationFailed(reason: OneSoftwareIdentityKitError.Reason.invalidContentType)
                    return
                }
                ...
                guard let method = request.httpMethod, method != "GET" else {
                    ...
                    error = OneSoftwareIdentityKitError.authorizationFailed(reason: OneSoftwareIdentityKitError.Reason.invalidRequestMethod)
                    return
                }
            ...
            case .query:
                ...
                var components = URLComponents(url: url, resolvingAgainstBaseURL: true)
                    ...
                    error = OneSoftwareIdentityKitError.authorizationFailed(reason: OneSoftwareIdentityKitError.Reason.invalidRequestURL)
                    return
                }
